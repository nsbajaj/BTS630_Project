...
| Number | Task Description | Status |
| --- | --- | --- |
| 1 | Re-Code methods for managing the categories.<br /> - Categories will be only related to cell phones such as Manufacturers, OS, Storage, etc. | Categories are handled but we have not made the categories system reflect new aspect, to do this we need a full audit of database. In terms of structure, the database is ready. |
| 2 | Re-Code methods for managing prodcuts and inventories.<br /> - Product Page will be reduced to show cell phones only, considering the new changes. | Inventory Page has been created and methods related to aproval have been removed, the controller lacks communication to database back end. |
