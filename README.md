...
| 4 | Admin/Seller will be able to alter the product(s).<br /> - Admin/Seller will be able to change the fields of the product(s), such as name, description, price, etc. |   |
