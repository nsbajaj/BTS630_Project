...
| 2 | Admin will be able to add the product(s) for another specific seller.<br /> - Admin should be able to  create products  for other sellers that aren't his own as a means of  technical support or any other issue with client end  this is done by selecting an id in the create menu |   |
