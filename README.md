...
| Number | Task Description | Status | 
| --- | --- | --- |
| 1 |**Inventory page**<br>Needs to be connected to the database and updated database<br>Add a link to create product |   |
| 2 | **User Dashboard** <br>Page needs to have a dashboard it should have  4 links<br>- Profile <br> - Orders <br>IF user is an admin there will be  2 aditional links <br>- Inventory <br>- Order to be shipped <br> |   |
| 3 | **Profile page**<br> Show user information <br> Edit link -functionality done<br>  |   |
| 4 | **Orders to be shipped** <br> back end calls(get orders, and  update order  status |   |
| 5 | **Orders** <br> -back end calls for update quantity and Cancelation  |   |
| 6 | **Paypal** <br> functionality to paypal |   |
